...
if (!Array.prototype.last) {
    Array.prototype.last = function() { if (this.length > 0) { return this[this.length - 1]; } else { return this } };
}; // enables [1,2,3].last()
...
class BaseVis {
    ...
    drawOutput(subplot) {
            ...
            function pltLine(key, className) {
                ...
                function mkLine(key) {
                    return d3.line().defined((d) => !isNaN(d[key]))
                        .x((d, i, all) => graphPlot.xScale(all.last().t - d.t))
        ...
        function updateAll(data) {
            ...
            let visibleData = d3.filter(data, (d, i, a) => d.t >= a.last().t - self.plotTime);
